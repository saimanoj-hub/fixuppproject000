...
// Add this to the top of worker-script.js
function checkMembership() {
    const plan = localStorage.getItem('fixUP_worker_plan');
    
    if (!plan) {
        // No plan selected - redirect to membership page
        setTimeout(() => {
            if (confirm('🚀 Get more clients! Choose a membership plan to unlock full features.')) {
